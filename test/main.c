...
/*   Updated: 2020/05/25 16:43:24 by apuchill         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#define INPUT_1	"this %.0f float", 1.6
#define INPUT_2	"%.0f", -3.85
#define INPUT_3	"%.0f", 573.924
#define INPUT_4	"%.7f", -875.000001
#define INPUT_5	"%.8f", -875.000001
