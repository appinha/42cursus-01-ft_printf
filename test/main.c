...
/*   Updated: 2020/05/20 00:02:45 by apuchill         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#define INPUT_1	"%f", 0.0894255
#define INPUT_2	"%.7f", 0.0894255
#define INPUT_3	"%f", 3.000001
#define INPUT_4	"%f", 5.9999999
#define INPUT_5	"this %.0f float", 1.6
